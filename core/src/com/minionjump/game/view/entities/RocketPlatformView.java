...
public class RocketPlatformView extends EntityView{

    public RocketPlatformView(MyMinionJump game){
        super(game);
    }

    public Sprite createSprite(MyMinionJump game){
        Texture texture = game.getAssetManager().get("platformRocket.png");
